...
test("delegate skill isolates trigger metadata and uses complete CLI commands", async () => {
  ...
  assert.match(frontmatter, /Do not trigger for TaskChef setup, configuration, or diagnosis/);
  assert.match(frontmatter, /status, outcomes, or live reports about delegated work/);
